...
static char * helptext[] = {
  "New FreeDOS MODE by Eric Auer 2003-2004. License: GPL.   (version " VERSION ")",
  ...
  "  Use MODE ... PREP=((,codepage) ...) to prepare codepage in second buffer.",
/* "  '...' can be one or more comma separated items:  numbers or empty strings.", */
  /* *** <- current MODE and DISPLAY only support ONE nonempty item! *** */
